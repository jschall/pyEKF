...
__RET_COV[0] = __R*((__SUBX[26])*(__SUBX[26])) + __R*((__SUBX[27])*(__SUBX[27])) + \
__SUBX[40]*__SUBX[44] + __SUBX[41]*__SUBX[47] + __SUBX[42]*__SUBX[45] + __SUBX[43]*__SUBX[46]; \
__RET_COV[1] = __R*__SUBX[26]*__SUBX[28] + __R*__SUBX[27]*__SUBX[29] + __SUBX[44]*__SUBX[51] + \
__SUBX[45]*__SUBX[48] + __SUBX[46]*__SUBX[50] + __SUBX[47]*__SUBX[49]; __RET_COV[2] = \
__R*__SUBX[26]*__SUBX[30] + __R*__SUBX[27]*__SUBX[31] + __SUBX[44]*__SUBX[52] + __SUBX[45]*__SUBX[55] \
+ __SUBX[46]*__SUBX[54] + __SUBX[47]*__SUBX[53]; __RET_COV[3] = __P[14]*__SUBX[42] + \
__P[21]*__SUBX[43] + __P[3]*__SUBX[41] + __P[9]*__SUBX[40] + __R*__SUBX[26]*__SUBX[32] + \
__R*__SUBX[27]*__SUBX[33] + __SUBX[44]*__SUBX[56] + __SUBX[45]*__SUBX[57] + __SUBX[46]*__SUBX[59] + \
__SUBX[47]*__SUBX[58]; __RET_COV[4] = __P[10]*__SUBX[40] + __P[15]*__SUBX[42] + __P[24]*__SUBX[43] + \
__P[4]*__SUBX[41] + __R*__SUBX[26]*__SUBX[34] + __R*__SUBX[27]*__SUBX[35] + __SUBX[44]*__SUBX[60] + \
__SUBX[45]*__SUBX[61] + __SUBX[46]*__SUBX[63] + __SUBX[47]*__SUBX[62]; __RET_COV[5] = \
__P[11]*__SUBX[40] + __P[16]*__SUBX[42] + __P[26]*__SUBX[43] + __P[5]*__SUBX[41] + \
__R*__SUBX[26]*__SUBX[36] + __R*__SUBX[27]*__SUBX[37] + __SUBX[44]*__SUBX[64] + __SUBX[45]*__SUBX[65] \
+ __SUBX[46]*__SUBX[67] + __SUBX[47]*__SUBX[66]; __RET_COV[6] = __R*__SUBX[26]*__SUBX[38] + \
__R*__SUBX[27]*__SUBX[39] + __SUBX[44]*__SUBX[68] + __SUBX[45]*__SUBX[69] + __SUBX[46]*__SUBX[71] + \
__SUBX[47]*__SUBX[70]; __RET_COV[7] = __R*((__SUBX[28])*(__SUBX[28])) + \
__R*((__SUBX[29])*(__SUBX[29])) + __SUBX[48]*__SUBX[72] + __SUBX[49]*__SUBX[73] + \
__SUBX[50]*__SUBX[74] + __SUBX[51]*__SUBX[75]; __RET_COV[8] = __R*__SUBX[28]*__SUBX[30] + \
__R*__SUBX[29]*__SUBX[31] + __SUBX[52]*__SUBX[75] + __SUBX[53]*__SUBX[73] + __SUBX[54]*__SUBX[74] + \
__SUBX[55]*__SUBX[72]; __RET_COV[9] = __P[14]*__SUBX[48] + __P[21]*__SUBX[50] + __P[3]*__SUBX[49] + \
__P[9]*__SUBX[51] + __R*__SUBX[28]*__SUBX[32] + __R*__SUBX[29]*__SUBX[33] + __SUBX[56]*__SUBX[75] + \
__SUBX[57]*__SUBX[72] + __SUBX[58]*__SUBX[73] + __SUBX[59]*__SUBX[74]; __RET_COV[10] = \
__P[10]*__SUBX[51] + __P[15]*__SUBX[48] + __P[24]*__SUBX[50] + __P[4]*__SUBX[49] + \
__R*__SUBX[28]*__SUBX[34] + __R*__SUBX[29]*__SUBX[35] + __SUBX[60]*__SUBX[75] + __SUBX[61]*__SUBX[72] \
+ __SUBX[62]*__SUBX[73] + __SUBX[63]*__SUBX[74]; __RET_COV[11] = __P[11]*__SUBX[51] + \
__P[16]*__SUBX[48] + __P[26]*__SUBX[50] + __P[5]*__SUBX[49] + __R*__SUBX[28]*__SUBX[36] + \
__R*__SUBX[29]*__SUBX[37] + __SUBX[64]*__SUBX[75] + __SUBX[65]*__SUBX[72] + __SUBX[66]*__SUBX[73] + \
__SUBX[67]*__SUBX[74]; __RET_COV[12] = __R*__SUBX[28]*__SUBX[38] + __R*__SUBX[29]*__SUBX[39] + \
__SUBX[68]*__SUBX[75] + __SUBX[69]*__SUBX[72] + __SUBX[70]*__SUBX[73] + __SUBX[71]*__SUBX[74]; \
__RET_COV[13] = __R*((__SUBX[30])*(__SUBX[30])) + __R*((__SUBX[31])*(__SUBX[31])) + \
...
__R*((__SUBX[33])*(__SUBX[33])) + __SUBX[56]*__SUBX[80] + __SUBX[57]*__SUBX[81] + \
__SUBX[58]*__SUBX[82] + __SUBX[59]*__SUBX[83]; __RET_COV[19] = __P[10]*__SUBX[56] + \
__P[15]*__SUBX[57] + __P[19] + __P[24]*__SUBX[59] + __P[4]*__SUBX[58] + __R*__SUBX[32]*__SUBX[34] + \
__R*__SUBX[33]*__SUBX[35] + __SUBX[60]*__SUBX[80] + __SUBX[61]*__SUBX[81] + __SUBX[62]*__SUBX[82] + \
__SUBX[63]*__SUBX[83]; __RET_COV[20] = __P[11]*__SUBX[56] + __P[16]*__SUBX[57] + __P[20] + \
__P[26]*__SUBX[59] + __P[5]*__SUBX[58] + __R*__SUBX[32]*__SUBX[36] + __R*__SUBX[33]*__SUBX[37] + \
__SUBX[64]*__SUBX[80] + __SUBX[65]*__SUBX[81] + __SUBX[66]*__SUBX[82] + __SUBX[67]*__SUBX[83]; \
__RET_COV[21] = __R*__SUBX[32]*__SUBX[38] + __R*__SUBX[33]*__SUBX[39] + __SUBX[68]*__SUBX[80] + \
__SUBX[69]*__SUBX[81] + __SUBX[70]*__SUBX[82] + __SUBX[71]*__SUBX[83]; __RET_COV[22] = \
__P[10]*__SUBX[60] + __P[15]*__SUBX[61] + __P[22] + __P[24]*__SUBX[63] + __P[4]*__SUBX[62] + \
__R*((__SUBX[34])*(__SUBX[34])) + __R*((__SUBX[35])*(__SUBX[35])) + __SUBX[60]*__SUBX[84] + \
__SUBX[61]*__SUBX[85] + __SUBX[62]*__SUBX[86] + __SUBX[63]*__SUBX[87]; __RET_COV[23] = \
__P[11]*__SUBX[60] + __P[16]*__SUBX[61] + __P[23] + __P[26]*__SUBX[63] + __P[5]*__SUBX[62] + \
__R*__SUBX[34]*__SUBX[36] + __R*__SUBX[35]*__SUBX[37] + __SUBX[64]*__SUBX[84] + __SUBX[65]*__SUBX[85] \
+ __SUBX[66]*__SUBX[86] + __SUBX[67]*__SUBX[87]; __RET_COV[24] = __R*__SUBX[34]*__SUBX[38] + \
__R*__SUBX[35]*__SUBX[39] + __SUBX[68]*__SUBX[84] + __SUBX[69]*__SUBX[85] + __SUBX[70]*__SUBX[86] + \
__SUBX[71]*__SUBX[87]; __RET_COV[25] = __P[11]*__SUBX[64] + __P[16]*__SUBX[65] + __P[25] + \
__P[26]*__SUBX[67] + __P[5]*__SUBX[66] + __R*((__SUBX[36])*(__SUBX[36])) + \
__R*((__SUBX[37])*(__SUBX[37])) + __SUBX[64]*(__P[11] + __P[12]*__SUBX[67] + __P[1]*__SUBX[66] + \
__P[7]*__SUBX[64] + __P[8]*__SUBX[65]) + __SUBX[65]*(__P[13]*__SUBX[65] + __P[16] + \
...
((__P[14])*(__P[14]))*__R*__SUBX[2] - ((__P[14])*(__P[14]))*__SUBX[0] - \
__P[14]*__SUBX[0]*(-__P[14]*__SUBX[1] + __P[14]) + __P[18]; __RET_COV[19] = \
__P[14]*__P[15]*__R*__SUBX[2] - __P[14]*__P[15]*__SUBX[0] - __P[15]*__SUBX[0]*(-__P[14]*__SUBX[1] + \
__P[14]) + __P[19]; __RET_COV[20] = __P[14]*__P[16]*__R*__SUBX[2] - __P[14]*__P[16]*__SUBX[0] - \
__P[16]*__SUBX[0]*(-__P[14]*__SUBX[1] + __P[14]) + __P[20]; __RET_COV[21] = \
__P[14]*__P[17]*__R*__SUBX[2] - __P[14]*__P[17]*__SUBX[0] - __P[17]*__SUBX[0]*(-__P[14]*__SUBX[1] + \
__P[14]) + __P[21]; __RET_COV[22] = ((__P[15])*(__P[15]))*__R*__SUBX[2] - \
((__P[15])*(__P[15]))*__SUBX[0] - __P[15]*__SUBX[0]*(-__P[15]*__SUBX[1] + __P[15]) + __P[22]; \
__RET_COV[23] = __P[15]*__P[16]*__R*__SUBX[2] - __P[15]*__P[16]*__SUBX[0] - \
...
__P[15]) + __P[24]; __RET_COV[25] = ((__P[16])*(__P[16]))*__R*__SUBX[2] - \
((__P[16])*(__P[16]))*__SUBX[0] - __P[16]*__SUBX[0]*(-__P[16]*__SUBX[1] + __P[16]) + __P[25]; \
__RET_COV[26] = __P[16]*__P[17]*__R*__SUBX[2] - __P[16]*__P[17]*__SUBX[0] - \
__P[17]*__SUBX[0]*(-__P[16]*__SUBX[1] + __P[16]) + __P[26]; __RET_COV[27] = \
((__P[17])*(__P[17]))*__R*__SUBX[2] - ((__P[17])*(__P[17]))*__SUBX[0] - \
...
((__P[20])*(__P[20]))*__SUBX[0] - __P[20]*__SUBX[0]*(-__P[20]*__SUBX[1] + __P[20]); __RET_COV[19] = \
__P[19] + __P[20]*__P[23]*__R*__SUBX[2] - __P[20]*__P[23]*__SUBX[0] - \
__P[23]*__SUBX[0]*(-__P[20]*__SUBX[1] + __P[20]); __RET_COV[20] = __P[20]*__P[25]*__R*__SUBX[2] + \
(-__SUBX[1] + 1)*(-__P[20]*__SUBX[1] + __P[20]); __RET_COV[21] = __P[20]*__P[26]*__R*__SUBX[2] - \
__P[20]*__P[26]*__SUBX[0] + __P[21] - __P[26]*__SUBX[0]*(-__P[20]*__SUBX[1] + __P[20]); __RET_COV[22] \
= __P[22] + ((__P[23])*(__P[23]))*__R*__SUBX[2] - ((__P[23])*(__P[23]))*__SUBX[0] - \
__P[23]*__SUBX[0]*(-__P[23]*__SUBX[1] + __P[23]); __RET_COV[23] = __P[23]*__P[25]*__R*__SUBX[2] + \
(-__SUBX[1] + 1)*(-__P[23]*__SUBX[1] + __P[23]); __RET_COV[24] = __P[23]*__P[26]*__R*__SUBX[2] - \
__P[23]*__P[26]*__SUBX[0] + __P[24] - __P[26]*__SUBX[0]*(-__P[23]*__SUBX[1] + __P[23]); __RET_COV[25] \
= ((__P[25])*(__P[25]))*__R*__SUBX[2] + __P[25]*((-__SUBX[1] + 1)*(-__SUBX[1] + 1)); __RET_COV[26] = \
__P[25]*__P[26]*__R*__SUBX[2] - __P[26]*__SUBX[1]*(-__SUBX[1] + 1) + __P[26]*(-__SUBX[1] + 1); \
__RET_COV[27] = ((__P[26])*(__P[26]))*__R*__SUBX[2] - ((__P[26])*(__P[26]))*__SUBX[0] - \
__P[26]*__SUBX[0]*(-__P[26]*__SUBX[1] + __P[26]) + __P[27]; 
...
__R*((__SUBX[6])*(__SUBX[6])) + __R*((__SUBX[7])*(__SUBX[7])) + __SUBX[22]*__SUBX[6] + \
__SUBX[23]*__SUBX[7]; __RET_COV[8] = __P[14]*__SUBX[7] + __P[15]*__SUBX[6] + __P[8] + \
__R*__SUBX[6]*__SUBX[8] + __R*__SUBX[7]*__SUBX[9] + __SUBX[22]*__SUBX[8] + __SUBX[23]*__SUBX[9]; \
__RET_COV[9] = __R*__SUBX[10]*__SUBX[7] + __R*__SUBX[11]*__SUBX[6] + __SUBX[11]*__SUBX[22] + \
__SUBX[20]*__SUBX[23]; __RET_COV[10] = __R*__SUBX[12]*__SUBX[6] + __R*__SUBX[13]*__SUBX[7] + \
__SUBX[13]*__SUBX[23] + __SUBX[21]*__SUBX[22]; __RET_COV[11] = __P[11] + __P[20]*__SUBX[7] + \
__P[23]*__SUBX[6] + __R*__SUBX[14]*__SUBX[6] + __R*__SUBX[15]*__SUBX[7] + __SUBX[14]*__SUBX[22] + \
__SUBX[15]*__SUBX[23]; __RET_COV[12] = __P[12] + __P[21]*__SUBX[7] + __P[24]*__SUBX[6] + \
__R*__SUBX[16]*__SUBX[6] + __R*__SUBX[17]*__SUBX[7] + __SUBX[16]*__SUBX[22] + __SUBX[17]*__SUBX[23]; \
__RET_COV[13] = __P[13] + __P[14]*__SUBX[9] + __P[15]*__SUBX[8] + __R*((__SUBX[8])*(__SUBX[8])) + \
__R*((__SUBX[9])*(__SUBX[9])) + __SUBX[24]*__SUBX[8] + __SUBX[25]*__SUBX[9]; __RET_COV[14] = \
__R*__SUBX[10]*__SUBX[9] + __R*__SUBX[11]*__SUBX[8] + __SUBX[11]*__SUBX[24] + __SUBX[20]*__SUBX[25]; \
__RET_COV[15] = __R*__SUBX[12]*__SUBX[8] + __R*__SUBX[13]*__SUBX[9] + __SUBX[13]*__SUBX[25] + \
__SUBX[21]*__SUBX[24]; __RET_COV[16] = __P[16] + __P[20]*__SUBX[9] + __P[23]*__SUBX[8] + \
__R*__SUBX[14]*__SUBX[8] + __R*__SUBX[15]*__SUBX[9] + __SUBX[14]*__SUBX[24] + __SUBX[15]*__SUBX[25]; \
__RET_COV[17] = __P[17] + __P[21]*__SUBX[9] + __P[24]*__SUBX[8] + __R*__SUBX[16]*__SUBX[8] + \
__R*__SUBX[17]*__SUBX[9] + __SUBX[16]*__SUBX[24] + __SUBX[17]*__SUBX[25]; __RET_COV[18] = \
__R*((__SUBX[10])*(__SUBX[10])) + __R*((__SUBX[11])*(__SUBX[11])) + __SUBX[11]*(__P[19]*__SUBX[20] + \
__P[22]*__SUBX[11]) + __SUBX[20]*(__P[18]*__SUBX[20] + __P[19]*__SUBX[11]); __RET_COV[19] = \
__R*__SUBX[10]*__SUBX[13] + __R*__SUBX[11]*__SUBX[12] + __SUBX[13]*(__P[18]*__SUBX[20] + \
__P[19]*__SUBX[11]) + __SUBX[21]*(__P[19]*__SUBX[20] + __P[22]*__SUBX[11]); __RET_COV[20] = \
__P[20]*__SUBX[20] + __P[23]*__SUBX[11] + __R*__SUBX[10]*__SUBX[15] + __R*__SUBX[11]*__SUBX[14] + \
